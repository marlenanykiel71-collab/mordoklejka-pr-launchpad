...
const appCss = "/assets/styles-CM_O3l55.css";
...
const Route$7 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mordoklejka — agencja PR. Strategia, media relations, PR kryzysowy, content i wizerunek online." },
      { property: "og:title", content: "Mordoklejka — agencja PR" },
      { property: "og:description", content: "Mordoklejka — agencja PR. Strategia, media relations, PR kryzysowy, content i wizerunek online." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Mordoklejka — agencja PR" },
      { name: "twitter:description", content: "Mordoklejka — agencja PR. Strategia, media relations, PR kryzysowy, content i wizerunek online." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/097791f5-760c-4e24-b6db-cd7d11c1b255/id-preview-9504804f--95f66e2f-3135-48ef-92fe-3114d41e9cb8.lovable.app-1779791813377.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/097791f5-760c-4e24-b6db-cd7d11c1b255/id-preview-9504804f--95f66e2f-3135-48ef-92fe-3114d41e9cb8.lovable.app-1779791813377.png" }
    ],
    links: [
...
const $$splitComponentImporter$6 = () => import("./uslugi-Da3Q0-mt.js");
const Route$6 = createFileRoute("/uslugi")({
  head: () => ({
    meta: [{
      title: "Usługi — Mordoklejka PR"
    }, {
      name: "description",
      content: "Strategia PR, media relations, PR kryzysowy, content, social media, CSR/ESG, public affairs."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./portfolio-DTuM_4vj.js");
const Route$5 = createFileRoute("/portfolio")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Case studies i zrealizowane projekty PR."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./o-nas-DrCPtmqj.js");
const Route$4 = createFileRoute("/o-nas")({
  head: () => ({
    meta: [{
      title: "O nas — Mordoklejka PR"
    }, {
      name: "description",
      content: "Poznaj agencję Mordoklejka — misja, wartości i zespół."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./kontakt-DJ49ncMR.js");
const Route$3 = createFileRoute("/kontakt")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Skontaktuj się z agencją Mordoklejka. Telefon, e-mail, formularz."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./cennik-Bgw06umg.js");
const Route$2 = createFileRoute("/cennik")({
  head: () => ({
    meta: [{
      title: "Cennik — Mordoklejka PR"
    }, {
      name: "description",
      content: "Pakiety usług PR: Basic, Standard, Pro. Wycena indywidualna."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blog-pFAgERZF.js");
const Route$1 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Artykuły, komentarze eksperckie i analizy trendów PR."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BFTnScJ4.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Budujemy wizerunek, który działa. Strategia PR, media relations, content i PR kryzysowy."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const UslugiRoute = Route$6.update({
  id: "/uslugi",
  path: "/uslugi",
...
const ONasRoute = Route$4.update({
  id: "/o-nas",
  path: "/o-nas",
  getParentRoute: () => Route$7
});
...
const CennikRoute = Route$2.update({
  id: "/cennik",
  path: "/cennik",
  getParentRoute: () => Route$7
});
